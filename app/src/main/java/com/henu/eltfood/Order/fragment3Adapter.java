...
public class fragment3Adapter extends RecyclerView.Adapter {
    ArrayList<FoodInTrade> list;
    Context context;
    int layout;

    public fragment3Adapter(Context context,int id, ArrayList<FoodInTrade> list){
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            food_image = itemView.findViewById(R.id.food_image2);
            food_description = itemView.findViewById(R.id.food_description2);
            food_price = itemView.findViewById(R.id.food_price2);
            food_count = itemView.findViewById(R.id.food_count2);
        }
    }
}
